...
*/
    ...
    vec4 rr= vec4(1.0,1.0,0.0,0.0);
    vec4 gg= vec4(0.0,1.0,1.0,1.0);
    vec4 bb= vec4(0.0,0.0,0.0,1.0);
    vec4 rrr=vec4(0.0,0.20,0.5, 0.5); //0.25);
    vec4 ggg=vec4(1.0,0.20,0.0, 0.0); //0.5 );
    vec4 bbb=vec4(1.0,1.0,0.5, 0.5); //0.75);
...
//  scalecolor = 0:6 after subtracting 2.
   ...
   {r=rrr[3]; g = ggg[3]; b=bbb[3]; }
    ...
    {    Color = vec4(1.0,1.0,1.0,1.);   // white border
    }
